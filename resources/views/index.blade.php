...
<body id="page-top">
  ...
  <header class="masthead">
    <div class="container">
      <div class="intro-text">
        ...
        <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="{{url('/form')}}">Get to know about your child</a>
        <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="{{url('/activities')}}">Activities for child</a>
      </div>
    </div>
  </header>
      ...
      <div class="row text-center">
        <div class="col-md-3">
          <span class="fa-stack fa-4x">
            <a href="/resources">
            <img class="card-img-top mx-auto d-block" src="{{ asset('img/2.jpg')}}" align="center" alt="Card image cap" style="width: 150px; height:125px;"></a><br>
        ...
        <div class="col-md-3">
          <span class="fa-stack fa-4x">
            <a href ="/apply">
            <img class="card-img-top mx-auto d-block" src="{{ asset('img/s1.jpg')}}" align="center" alt="Card image cap" style="width: 150px; height:125px;"><br></a>
          </span>


          <h4 class="service-heading">Apply for treatment</h4>
          <p class="text-muted">We provide simple activities that helps to improve child's brain</p>
        </div>
        <div class="col-md-3">
          <span class="fa-stack fa-4x">
          <a href="#app">
          <img class="card-img-top mx-auto d-block" src="{{ asset('img/s2.jpg')}}" align="center" alt="Card image cap" style="width: 150px; height:125px;"></a><br>
        ...
        <div class="col-md-3">
          <span class="fa-stack fa-4x"><a href="/form">
          <img class="card-img-top mx-auto d-block" src="{{ asset('img/s2.jpg')}}" align="center" alt="Card image cap" style="width: 150px; height:125px;"></a><br></a>
          </span>
  ...
  <section class="bg-light" id="portfolio">
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center" id="app">
